...
public class Line extends AbstractShape {
    ...
    public boolean contains(Point point) {
        return (Point.distance(point.x, point.y, this.getPosition().x, this.getPosition().y) + Point.distance(point.x, point.y, p2.x, p2.y)) == Point.distance(this.getPosition().x, this.getPosition().y, p2.x, p2.y);
    }
